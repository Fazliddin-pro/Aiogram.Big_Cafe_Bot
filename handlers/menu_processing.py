...
async def main_menu(session, level, menu_name):
    ...
    if banner.image:
        ...
        # Здесь можно определить, что делать, если изображения нет
        image = None  # или любое другое значение по умолчанию
        caption = banner.description  # отправка только текста
